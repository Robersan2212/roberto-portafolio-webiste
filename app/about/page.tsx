          ...
          <div className="flex flex-1 flex-col justify-center">
            <div className="max-w-2xl space-y-6 text-left">
              ...
              <div className="space-y-2">
                ...
                <ul className="flex flex-wrap justify-start gap-x-4 gap-y-1 font-sans text-base text-zinc-400 sm:text-lg">
                  <li>
                    <a
                      href="https://www.credly.com/badges/e00a43da-a0ac-490d-b014-fc5d4e2576bd/public_url"
                      target="_blank"
                  ...
                  <li>
                    <a
                      href="https://www.credly.com/badges/a831a758-7f7a-4676-8784-51eadd3f54de/public_url"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="underline decoration-zinc-500 underline-offset-2 transition-colors hover:text-zinc-300 hover:decoration-zinc-400"
                    >
