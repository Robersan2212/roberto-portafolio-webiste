...
class AsciiFilter {
  ...
  constructor(renderer: THREE.WebGLRenderer, { fontSize, fontFamily, charset, invert, darkBackground, asciiColor }: AsciiFilterOptions = {}) {
    ...
    this.asciiColor = asciiColor ?? '#d4d4d8';
  ...
  reset() {
    if (this.context) {
      ...
      if (this.darkBackground) {
        this.pre.style.color = this.asciiColor;
        this.pre.style.backgroundImage = 'none';
        this.pre.style.backgroundClip = 'unset';
        this.pre.style.webkitTextFillColor = this.asciiColor;
        this.pre.style.webkitBackgroundClip = 'unset';
...
class CanvAscii {
  ...
  constructor(
    { text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, darkBackground, asciiColor }: CanvAsciiOptions,
    ...
    this.darkBackground = darkBackground ?? false;
    this.asciiColor = asciiColor ?? textColor;
...
export default function ASCIIText({
  ...
  useEffect(() => {
    ...
    const createAndInit = async (container: HTMLDivElement, w: number, h: number) => {
      const instance = new CanvAscii(
        { text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, darkBackground, asciiColor: asciiColor ?? textColor },
        container,
        w,
        h
      );
  ...
  }, [text, asciiFontSize, textFontSize, textColor, planeBaseHeight, enableWaves, darkBackground, asciiColor]);
